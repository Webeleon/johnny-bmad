...
- [Architecture Decision Document](#table-of-contents)
  ...
  - [Starter Template Evaluation](./starter-template-evaluation.md)
    ...
    - [Selected Starter: johnny-bmad v0.2.0 Architecture (Brownfield Enhancement)](./starter-template-evaluation.md#selected-starter-johnny-bmad-v020-architecture-brownfield-enhancement)
    - [Architectural Decisions Provided by Existing v0.2.0](./starter-template-evaluation.md#architectural-decisions-provided-by-existing-v020)
    - [Enhancement Strategy for Batch Workflow (v1)](./starter-template-evaluation.md#enhancement-strategy-for-batch-workflow-v1)
  - [Core Architectural Decisions](./core-architectural-decisions.md)
    ...
    - [Workflow Routing Architecture](./core-architectural-decisions.md#workflow-routing-architecture)
